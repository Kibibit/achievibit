...
export interface IEngine<IEventPayload> {
  /**
   ...
   */
  handleNewConnection(eventData: IEventPayload): Promise<void>;
   ...
   * @param eventData the event payload
   */
  handlePullRequestOpened(eventData: IEventPayload): Promise<void>;
   ...
   * @param eventData the event payload
   */
  handlePullRequestInitialLabeled(eventData: IEventPayload): Promise<void>;
   ...
   * @param eventData the event payload
   */
  handlePullRequestLabelAdded(eventData: IEventPayload): Promise<void>;
   ...
   * @param eventData the event payload
   */
  handlePullRequestLabelRemoved(eventData: IEventPayload): Promise<void>;
   ...
   * @param eventData the event payload
   */
  handlePullRequestEdited(eventData: IEventPayload): Promise<void>;
   ...
   * @param eventData the event payload
   */
  handlePullRequestAssigneeAdded(eventData: IEventPayload): Promise<void>;
   ...
   * @param eventData the event payload
   */
  handlePullRequestAssigneeRemoved(eventData: IEventPayload): Promise<void>;
   ...
   * @param eventData the event payload
   */
  handlePullRequestReviewRequestAdded(eventData: IEventPayload): Promise<void>;
   ...
   * @param eventData the event payload
   */
  handlePullRequestReviewRequestRemoved(eventData: IEventPayload): Promise<void>;
   ...
   * @param eventData the event payload
   */
  handlePullRequestReviewCommentAdded(eventData: IEventPayload): Promise<void>;
   ...
   * @param eventData the event payload
   */
  handlePullRequestReviewCommentRemoved(eventData: IEventPayload): Promise<void>;
   ...
   * @param eventData the event payload
   */
  handlePullRequestReviewCommentEdited(eventData: IEventPayload): Promise<void>;
   ...
   * @param eventData the event payload
   */
  handlePullRequestReviewSubmitted(eventData: IEventPayload): Promise<void>;
   ...
   * @param eventData the event payload
   */
  handlePullRequestMerged(eventData: IEventPayload): Promise<void>;
}
