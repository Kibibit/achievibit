...
export * from './oauth/github.strategy';
export * from './oauth/oauth.module';
export * from './oauth/oauth.service.spec';
...
export * from './pull-requests/pull-requests.service.spec';
...
export * from './repos/repos.service.spec';
export * from './repos/repos.service';
export * from './shields/shields.controller.spec';
export * from './shields/shields.controller';
export * from './shields/shields.module';
export * from './shields/shields.service.spec';
